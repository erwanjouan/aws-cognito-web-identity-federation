...
function credentialExchange(googleToken) {
  ...
  if (googleTokenDecoded['sub']) {
    ...
    AWS.config.credentials = new AWS.CognitoIdentityCredentials({
      IdentityPoolId: 'us-east-1:c09c9b9c-384f-4f6e-9fbf-57bd902458cf', // MAKE SURE YOU REPLACE THIS
      Logins: {
...
function accessImages() {
  ...
  var s3 = new AWS.S3();
  var params = {
    Bucket: "webidf-patchesprivatebucket-tkar54jz8wb7" // MAKE SURE YOU REPLACE THIS
  }; 
